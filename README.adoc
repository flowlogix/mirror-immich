...
* Download https://raw.githubusercontent.com/flowlogix/mirror-immich/refs/heads/main/docker-compose.yaml[Docker Compose] and
https://raw.githubusercontent.com/flowlogix/mirror-immich/refs/heads/main/defaults.env[Default Environment] files.
* Run `docker compose up -d` to start the container.
* Browse http://localhost:9090 to access MirrorImmich.

You can also create `.env` file with the following variables:
[source,dotenv]
----
