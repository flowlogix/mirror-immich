...
* [ ] Create the album structure in Immich that exists in Photos.
* [ ] Mark photos as favorite in Immich that were favorite in Photos.
* [ ] Progressive export - only export what hasn't been exported already.
* [ ] Delete from Immich what was deleted from Photos.
* [ ] Create a structure in which Edited videos can be exported (since Photos doesn't store those directly).
